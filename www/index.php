<?php require_once __DIR__ . '/../../mountaineer-vip-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>VIP Preferred at Mountaineer Casino, Racetrack & Resort</title>
    <?php require_once __DIR__ . '/../../mountaineer-vip-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
    ...
    <script async defer src="https://tools.luckyorange.com/core/lo.js?site-id=a9e6ca46"></script>
</head>
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=mountaineer-vip&client_id=4e3275840f668408e469f5007d720b6d" type="text/javascript"></script>
